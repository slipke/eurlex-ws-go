...
func TestToXML(t *testing.T) {
	...
	shouldXML := `<soap:Envelope xmlns:sear="http://eur-lex.europa.eu/search" xmlns:soap="http://www.w3.org/2003/05/soap-envelope">
	<soap:Header>
	...
	<soap:Body>
		<sear:searchRequest>
			<sear:expertQuery>testserach</sear:expertQuery>
